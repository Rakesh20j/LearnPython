...
e={} #empty dictionary
e["rakesh"]=30 #add key value pair
print(e)
...
class Robot1:
    def __init__(self,name,color,weight):#using constructor
        self.name = name
        self.color = color
        self.weight = weight
...
class Person:
    ...
    def sit_down(self): #method
        self.is_sitting=True
        
    def stand_up(self): #method
...
p1.robot_owned.introduce_self1()
p2.robot_owned.introduce_self1()
